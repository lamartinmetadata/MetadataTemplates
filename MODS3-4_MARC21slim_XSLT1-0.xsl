...
<!-- Note -->	
	<!-- 1/04 fix -->
	<xsl:template match="mods:note[not(@type='statementOfResponsibility')]">
		<xsl:call-template name="datafield">
			<xsl:with-param name="tag">
				<xsl:choose>
...
-->
	...
	<xsl:template name="stmtOfResponsibility">
		<xsl:for-each select="following-sibling::mods:note[@type='statementOfResponsibility']">		
			<marc:subfield code='c'>
				<xsl:value-of select="."/>
			</marc:subfield>
		</xsl:for-each>
...
<!-- Identifiers -->	
	...
	<!--v3 location/url -->
	<xsl:template match="mods:location[mods:url]" priority="5">
...
<!-- v3.4 add physical location url -->
	...
	<!-- v3.4 location url -->
	<xsl:template match="mods:location[mods:url]" priority="2">
		<xsl:for-each select="mods:url">
			<xsl:call-template name="datafield">
				<xsl:with-param name="tag">852</xsl:with-param>
				<xsl:with-param name="subfields">
